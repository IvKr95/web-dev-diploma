...
const AddShowForm = (props) => {
  const {
    halls, onAddShow: addShow, onClose: handleModal,
  } = props;
...
Название зала
        <select className="conf-step__input" name="hall" value={showData.hall} onChange={handleChange} required>
...
Дата сеанса
        <input className="conf-step__input" type="text" name="date" value={showData.date} onChange={handleChange} required />
      </label>

      <label className="conf-step__label conf-step__label-fullsize" htmlFor="name">
Время начала
        <input className="conf-step__input" type="time" name="startTime" value={showData.startTime} onChange={handleChange} required />
      </label>

      <label className="conf-step__label conf-step__label-fullsize" htmlFor="name">
Название фильма
        <input className="conf-step__input" type="text" name="name" placeholder="Например, &laquo;Название Фильма&raquo;" value={showData.name} onChange={handleChange} required />
      </label>
