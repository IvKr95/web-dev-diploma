...
import Show from '../admin/models/Show';
  ...
  const WithAdminLogic = (props) => {
    ...
    const handleDelete = (e) => {
      ...
      if (action === 'deleteHall') {
        remove({
          url: `${process.env.REACT_APP_ADMIN_URL}/${itemToDelete}`,
          body: { action: 'deleteShows' },
          callback: () => {
            remove({
              url: `${process.env.REACT_APP_ADMIN_URL}/${itemToDelete}`,
              body: { action },
        ...
        remove({
          url: `${process.env.REACT_APP_ADMIN_URL}/${itemToDelete.showId}`,
          body: { action },
          callback: () => {
            fetchShows();
          },
